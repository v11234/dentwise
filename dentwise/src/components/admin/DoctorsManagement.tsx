import { useGetDoctors, useUpdateDoctor } from "@/hooks/use-doctors";
import { useState } from "react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "../ui/card";
import { CheckCircle2Icon, EditIcon, MailIcon, PhoneIcon, PlusIcon, StethoscopeIcon } from "lucide-react";
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  {doctor.accountStatus === "ACTIVE" ? (
                    ...
                    <Badge variant="secondary">Pro Pending</Badge>
                  )}
                  ...
                  {doctor.accountStatus !== "ACTIVE" ? (
                    ...
                    >
                      <CheckCircle2Icon className="mr-1 size-4" /> Approve
                    </Button>
                  ) : null}
