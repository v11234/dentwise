...
function AppointmentConfirmationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your dental appointment request was received</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={h1}>Appointment Request Received</Heading>

          <Text style={text}>Hi there,</Text>

          <Text style={text}>
            Your request has been sent to the doctor for approval. Here are the details:
          </Text>
          ...
          <Text style={text}>
            We will notify you once the doctor accepts or rejects your request. You can track the
            status in your DentWise dashboard.
          </Text>
